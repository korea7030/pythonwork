...
search_results = twitter_api.friends.ids(screen_name="sangyuplee79")
search_results1 = twitter_api.followers.ids(screen_name="sangyuplee79")

print(search_results)
search_results = json.dumps(search_results, indent=1)

f = codecs.open('friends_ids_results.txt', encoding='utf-8', mode='w')
