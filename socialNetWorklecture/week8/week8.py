...
## 회원리뷰 버튼 클릭
element = driver.find_element_by_xpath('/html/body/div[2]/div[5]/form/table/tbody/tr/td/div/ul/li[7]/a/img')
element.click()

## 전체리뷰 펼쳐보기 클릭
element2 = driver.find_element_by_xpath('/html/body/div[2]/div[5]/form/table/tbody/tr/td/div/div[8]/div[12]/div[3]/div[1]/span/a/img[2]')
element2.click()
