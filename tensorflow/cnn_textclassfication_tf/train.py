    ...
    with sess.as_default():
        ...
        for g,v in grads_and_vars:
            if g is not None:
                ...
                grad_summarise.append(grad_hist_summary)
                grad_summarise.append(sparsity_summary)

        grad_summarise_merged = tf.summary.merge(grad_summarise)
        ...
        # Train Summaries
        train_summary_op = tf.summary.merge([loss_summary, acc_summary, grad_summarise_merged])
        train_summary_dir = os.path.join(out_dir, "summaries", "tain")
