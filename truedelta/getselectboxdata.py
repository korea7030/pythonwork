...
if __name__ == '__main__':
    ...
    element_year = driver.find_element_by_xpath(
        "/html/body/div[3]/div[2]/div/div[1]/form/fieldset/table/tbody/tr[2]/td/select[@name='year']")
    element_brand = driver.find_element_by_xpath(
        "/html/body/div[3]/div[2]/div/div[1]/form/fieldset/table/tbody/tr[3]/td/select[@name='brand']")
    ...
    element_probarea = driver.find_element_by_xpath(
        "/html/body/div[3]/div[2]/div/div[1]/form/fieldset/table/tbody/tr[5]/td/select[@name='problem_area']")
